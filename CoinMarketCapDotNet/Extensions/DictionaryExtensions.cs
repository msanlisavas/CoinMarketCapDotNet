...
namespace CoinMarketCapDotNet.Extensions
{
    ...
    this IDictionary<TKey, TValue> dictionary, IEnumerable<TKey> keys) where TKey : notnull
        {
    ...
    this IDictionary<TKey, TValue> dictionary, Func<TValue, bool> predicate) where TKey : notnull
        {
